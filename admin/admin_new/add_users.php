                ...
                <div class="tab-pane active" id="home">
                    ...
                    <div class="add_produ">
                         ...
                         <!-- RECENT ACTIVITY -->
							  ...
							  <div class="col-md-6">                                    <div class="form-group">                                        <label class="col-md-3 control-label" for="name">Last Name</label>                                        <div class="col-md-9">                                        <input id="lastname" name="lastname" type="text" placeholder="Your name" class="form-control" value="<?=$row['last_name']?>">                                        </div>                                    </div>							</div>
							  ...
							  <div class="row">
							    ...
							    <div class="col-md-6">  
							     ...
							     <div class="col-md-6">
								<div class="form-group">
									<label class="col-md-2 control-label" for="email">City</label>
									<div class="col-md-10">
