...
if(isset($_POST['Submit']) and $_POST['Submit']=="Save")
	{
$up=new UPLOAD();
$uploaddir3="../../upload/food_ordering/category/";
...
$updatearr=array(	"catname"=>$catname,					
					...
					"packing_fee"=>$_REQUEST['packing_fee'],
	...
	if(matchExists('recipe_categories', $whereClause))
		{
			...
			if($act=="edit")
				{
					...
					updateData($updatearr, 'recipe_categories', $whereClause);
					
					$errMsg='<br><b>Update Successfully!</b><br>';
				}elseif($act=="add"){
				
					$insid=insertData($updatearr, 'recipe_categories');
...
if(!empty($catid) and $act=="edit")
	{
		$sql="SELECT * FROM recipe_categories WHERE id=$catid";
...
<div class="row">
                                               <div class="form-group">
                                        <label class="col-md-2 control-label" for="name">Packing fee <span class=""></span></label>
                                        <div class="col-md-10">
                                        <input id="packing_fee" name="packing_fee" type="text" placeholder="Packing fee" class="form-control" value="<?=$row['packing_fee']?>" >
                                        </div>
                                    </div>
	</div>						
