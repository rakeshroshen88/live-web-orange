...
function deladmin(id)
{
	...
	{
		location.href="https://orangestate.ng/admin/admin_new/subsubcategory_list.php?act=del&id="+id;
	}
}
</script>
...
$st=mktime(0,0,0,$date[1],$date[2],$date[0]);			
	...
	<tr>
						<td><?=$ct?></td>
                        <td> <a href="https://orangestate.ng/admin/admin_new/add_subsubcategory.php?act=edit&id=<?=$row['id']?>"><?=$row['subsubcatname']?></a></td>
							<td><?=$cat?></td>
<td><?=$subcatname?></td>
                   
						<td> <?php echo date('d M,Y',$st);?></td>
                    <td> <a href='https://orangestate.ng/admin/admin_new/subsubcategory_list.php?act=dac&id=<?=$row['id']?>&stat=<?=$row['sub_status']?>'><?=$row['sub_status']=='0'?'Deactive':'Active'?></a> </td>
                           
                        <td > <a href="https://orangestate.ng/admin/admin_new/add_subsubcategory.php?act=edit&id=<?=$row['id']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span></a>
						</td>
                     </tr>
