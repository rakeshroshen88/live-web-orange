...
$subsubcatname = mysqli_real_escape_string($link, $_REQUEST['catname']);
...
$updatearr=array(	 "catid"=>$_REQUEST['category'],
	...
	if($act=="edit")
		{
		$whereClause=" catid=".$_REQUEST['category']." and subsubcatname='".$_REQUEST['catname']."' and id!=".$_REQUEST['id'] ;
		}elseif($act=="add"){
		$whereClause=" catid=".$_REQUEST['category']." and subsubcatname='".$_REQUEST['catname']."'" ;
		}
	if(matchExists($_TBL_SUBSUBCAT, $whereClause))
		{
                        ...
                        <option value="<?=$row1['id']?>" <?=$select1?>><?=$row1['subcatname']?></option>
						 ...
						 <?php } ?>
						 	<?php } ?>
												...
												<div class="row">
                                               <div class="form-group">
                                        <label class="col-md-2 control-label" for="name">Sub subcategory Name: <span class="required">*</span></label>
                                        <div class="col-md-10">
                                        <input id="catname" name="catname" type="text" placeholder=" Subcategory Name:" class="form-control" required value="<?=$row['subsubcatname']?>">
                                        </div>
                                    </div>
	</div>						
