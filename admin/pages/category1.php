...
function deladmin(id)
{
	...
	{
		location.href="<?=$_PAGE.'?'.$qryStr?>&mod=cat1&act=del&id="+id;
	}
}
</script>
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Company Category Management</li>
			</ol>
		</div><!--/.row   All count-->
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=$count=$db->getSingleResult("select count(*) from com_category");	?></div>
            ...
            <div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
						<div class="large"><?=$count=$db->getSingleResult("select count(*) from com_category where status='1'");	?></div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
                        ...
                        <div class="add-pro">
                            <a href="main.php?mod=add_cat1&act=add">Add Category</a>
...
$db1=new DB();
	...
	if(!empty($_REQUEST['firstname']) or isset($_REQUEST['firstname']))
	 ...
	 $sql="SELECT * from com_category".$wherestr." order by id desc";
	$db->query($sql);
...
?>	
 					<tr>
						<td></td>
                        <td> <a href="main.php?mod=add_cat1&act=edit&id=<?=$row['id']?>"><?=$row['catname']?></a></td>
							
                   
						<td> <?php echo date('d M,Y',$st);?></td>
                    <td> <a href='main.php?mod=cat1&act=dac&id=<?=$row['id']?>&stat=<?=$row['status']?>'><?=$row['status']=='no'?'Deactive':'Active'?></a> </td>
                           
                        <td > <a href="main.php?mod=add_cat1&act=edit&id=<?=$row['id']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span></a>
						</td>
                     </tr>
<?php } ?>
<?php	}else{
