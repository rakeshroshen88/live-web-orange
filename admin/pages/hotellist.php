				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=$count=$db->getSingleResult("select count(*) from $_TBL_HOTELLIST");	?></div>
            ...
            <div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
						<div class="large"><?=$count=$db->getSingleResult("select count(*) from $_TBL_HOTELLIST where status='1'");	?></div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
                        ...
                        <div class="add-pro">
                            <a href="main.php?mod=addhotellist&act=add">Add Hotel</a>
...
$db1=new DB();
	...
	$sql="SELECT * from ".$_TBL_HOTELLIST.$wherestr." order by id desc";
	$db->query($sql);
...
?>	
 					<tr>
						<td></td>
                        <td> <a href="main.php?mod=addhotellist&act=edit&id=<?=$row['id']?>"><?=$row['title']?></a></td>
							
                       
						<td> <?php echo date('d M,Y',$st);?></td>
                    <td> <a href='main.php?mod=hotellist&act=dac&id=<?=$row['id']?>&stat=<?=$row['status']?>'><?=$row['status']==0?'Deactive':'Active'?></a> </td>
                           
                        <td > <a href="main.php?mod=addhotellist&act=edit&id=<?=$row['id']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span></a>
						</td>
                     </tr>
<?php } ?>
