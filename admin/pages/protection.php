...
$updatearr=array(	 
					    "page_detail"=>mysql_real_escape_string($_REQUEST['about']),
						"imageid"=>$largeimage,
					  "page_date"=>date('Y-m-d')
						);
					$whereClause=" id=7";
					updateData($updatearr, 'homepage', $whereClause);
					$errMsg='<br><b>Successfully Updated!</b><br>';

	}

 $sql="SELECT * FROM homepage WHERE id=7";
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Add/Edit Protection Levels</li> <span style="color:red; font-size:14px;"<?=$errMsg?></span>
			</ol>
		</div><!--/.row-->
							...
							<fieldset>
								<!-- Name input-->
                                    	...
                                    	<div class="form-group">
        									<label class="col-md-3 control-label">Protection Levels Detail</label>
            									<div class="col-md-9">
