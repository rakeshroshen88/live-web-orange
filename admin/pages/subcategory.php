...
function deladmin(id)
{
	...
	{
		location.href="<?=$_PAGE.'?'.$qryStr?>&mod=subcat&act=del&id="+id;
	}
}
</script>
<?php
				...
				<div class="panel panel-blue panel-widget ">
					...
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							...
							<div class="large"><?=$count=$db->getSingleResult("select count(*) from $_TBL_SUBCAT");	?></div>
            ...
            <div class="col-xs-12 col-md-6 col-lg-3">
				...
				<div class="panel panel-orange panel-widget">
					...
					<div class="row no-padding">
						...
						<div class="large"><?=$count=$db->getSingleResult("select count(*) from $_TBL_SUBCAT where status='1'");	?></div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
                        ...
                        <div class="add-pro">
                            ...
                            <a href="main.php?mod=add_subcat&act=add">Add Sub Category</a>
...
$db1=new DB();
	...
	if(!empty($_REQUEST['firstname']) or isset($_REQUEST['firstname']))
	 ...
	 $sql="SELECT * from ".$_TBL_SUBCAT.$wherestr." order by id desc";
...
?>	
 					...
 					<tr>
                        ...
                        <td> <a href="main.php?mod=add_subcat&act=edit&id=<?=$row['id']?>"><?=$row['subcatname']?></a></td>
                    ...
                    <td> <a href='main.php?mod=subcat&act=dac&id=<?=$row['id']?>&stat=<?=$row['sub_status']?>'><?=$row['sub_status']=='0'?'Deactive':'Active'?></a> </td>

                           

                        <td > <a href="main.php?mod=add_subcat&act=edit&id=<?=$row['id']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span></a>
