...
?>
			...
			include_once("pages/user.php");			}elseif($module=="subcat"){							include_once("pages/subcategory.php");						}elseif($module=="add_subcat"){							include_once("pages/add_edit_subcat.php");			}elseif($module=="subsubcat"){							include_once("pages/subsubcategory.php");						}elseif($module=="add_subsubcat"){							include_once("pages/add_edit_subsubcat.php");			}elseif($module=="viewproduct"){							include_once("pages/viewproduct.php");			}elseif($module=="addproduct"){							include_once("pages/addproduct.php");			}elseif($module=="order"){							include_once("pages/order.php");						}elseif($module=="order_detail"){							include_once("pages/order_detail.php");
			...
			include_once("pages/addcatlog.php");						}elseif($module=="cat"){							include_once("pages/category.php");			}elseif($module=="add_cat"){							include_once("pages/add_edit_category.php");						}elseif($module=="cat1"){							include_once("pages/category1.php");			}elseif($module=="add_cat1"){							include_once("pages/add_edit_category1.php");						}elseif($module=="intrest"){							include_once("pages/intrest.php");			}elseif($module=="add_intrest"){							include_once("pages/add_edit_intrest.php");						}elseif($module=="hospitality"){							include_once("pages/hospitality.php");			}elseif($module=="add_hospitality"){							include_once("pages/add_edit_hospitality.php");
