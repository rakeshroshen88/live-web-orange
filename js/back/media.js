		...
		var social_AjaxURL='http://orangestate.ng/ajax_signup.php';
			...
			el.block({
				...
				css: {
					...
					var dataString = 'name1='+ name + '&email1='+ email + '&password1='+ password + '&lastname='+ lastname + '&phoneno='+ phone + '&country='+ country + '&countrycode='+ countrycode + '&location='+ location + '&postal_code='+ postal_code;
