$(document).ready(function(){
	var URL='http://webz-engine.com/sample/orange_state2/';
...
/////////////////////////////////Register document////////////////////////////////////
		...
		var social_AjaxURL=URL+'ajax_signup.php';
			...
			el.block({
				...
				message: '<img src="'+URL+'/images/loading.gif" /> Just a moment...',
				css: {
					border: 'none',
					color: '#333',
					background: 'none'
            	    ...
            	    success: function (response) {
            		  ...
            		  // alert(response);
                       ...
                       if(data1.status==true){
                           // $('#success').html('Added');  
                             window.location = URL+"veryfyotp.php";
                             window.location.href = URL"veryfyotp.php";
                         // window.location.href= URL+'veryfyotp.php';
            		    }else{
	...
	jQuery(document).on("click", "#companysubmit ", function(e){
		...
		var social_AjaxURL=URL+'ajax_page_creation.php';
...
//$("#profilesubmit").click(function(){
	var URL=URL+'upload/';
var social_AjaxURL=URL+'imageupload.php';
        var fd = new FormData();
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response != 0){
                    //alert(response);
                    jQuery("#rmvid").hide();
                    jQuery(".left-uploaded-img").html('<img src="'+URL + response +'" />');
...
jQuery(document).on("click", "#profilesubmit ", function(e){
		...
		var social_AjaxURL=URL+'ajax_user_profile.php';
	...
	var social_AjaxURL=URL+'upload.php';
...
jQuery(document).on("click", "#uploadpost ", function(e){
		...
		var social_AjaxURL=URL+'ajax_post.php';
...
jQuery(document).on("click", "#like2", function(e){
		...
		var social_AjaxURL=URL+'ajax_like.php';
...
jQuery(document).on("click", "#follow", function(e){
		...
		var social_AjaxURL=URL+'ajax_follow.php';
...
jQuery(document).on("click", "#commentid ", function(e){
		...
		var social_AjaxURL=URL+'ajax_comment.php';
...
jQuery(document).on("click", "#replyid ", function(e){
		...
		var social_AjaxURL=URL+'ajax_reply.php';
...
var social_AjaxURL=URL+'commentimageupload.php';
        var fd = new FormData();
...
var social_AjaxURL=URL+'replyimageupload.php';
        var fd = new FormData();
...
jQuery(document).on("click", "#posthide", function(e){
		...
		var social_AjaxURL=URL+'ajax_post_hide.php';
...
jQuery(document).on("click", "#deletepost", function(e){
		...
		var d_id = jQuery(this).attr('hidepost');
		alert(d_id);
		
		//var img=jQuery("#profileimg").val();
		
		var social_AjaxURL=URL+'ajax_post_delete.php';
...
jQuery(document).on("click", "#editpost", function(e){
		...
		var social_AjaxURL=URL+'ajax_editpost_form.php';
