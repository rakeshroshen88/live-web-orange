...
<style type="text/css">
    ...
    <div class="topbanner">
        ...
        <img src="img/img-01.jpg" alt="code" />
    ...
    <main>
        <div class="main-section">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="tg-toursdestinations">
                                <div class="tg-tourdestination tg-tourdestinationbigbox">
                                    <figure>
                                        <a href="tour-destination-list.php?type=Ice Adventure Vacations">
                                            <img src="img/destination/img-01.jpg" alt="image destinations">
                                ...
                                <div class="tg-tourdestination">
                                    <figure>
                                        <a href="tour-destination-list.php?type=National Park">
                                            <img src="img/destination/img-02.jpg" alt="image destinations">
                                            <div class="tg-hoverbox">
                                                <div class="tg-adventuretitle">
                                                    <h2>National Park</h2>
                                                </div>
                                ...
                                <div class="tg-tourdestination">
                                    <figure>
                                        <a href="tour-destination-list.php?type=Adult Vacations">
                                            <img src="img/destination/img-03.jpg" alt="image destinations">
                                            <div class="tg-hoverbox">
                                                <div class="tg-adventuretitle">
			...
			*************************************-->
            ...
            <div class="tg-sectionspace tg-haslayout pixelbg tg-parallax">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
										...
										<?php 
										$db1=new DB();
										$wherestr1=' where populor=1 order by id limit 0,3';
										...
										$st=mktime(0,0,0,$date[1],$date[2],$date[0]);?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="item tg-populartour">
                                                    <figure>
                                                        <a href="tourbookingdetail.html"><img src="img/tours/img-01.jpg" alt="image destinations"></a>
                                                        <span class="tg-descount">New</span>
                                                    </figure>
                                                    <div class="tg-populartourcontent">
                                                        <div class="tg-populartourtitle">
                                    ...
                                    <div class="carousel-item">
										...
										if($db->numRows()>0){
											...
											$date=explode('-',$row['date']);
											$st=mktime(0,0,0,$date[1],$date[2],$date[0]);
											?>                                            <div class="col-md-4">                                                <div class="item tg-populartour">                                                    <figure>                                                        <a href="tour-destination-details.php?tourid=<?=$row['id']?>">														<?php if(!empty($row['picture'])){ ?>														<img src="destination/<?=$row['picture']?>" alt="image destinations">														<?php }else{ ?>														<img src="img/tours/img-01.jpg" alt="image destinations">														<?php } ?>														</a>                                                        <span class="tg-descount">New</span>                                                    </figure>                                                    <div class="tg-populartourcontent">                                                        <div class="tg-populartourtitle">                                                            <h3><a href="tour-destination-details.php?tourid=<?=$row['id']?>">															<?=$row['title']?></a></h3>                                                        </div>                                                        <div class="tg-description">                                                            <p><?=$row['weither']?></p>                                                        </div>                                                        <div class="tg-populartourfoot">                                                            <div class="tg-durationrating">                                                                <span class="tg-stars"><span></span></span>                                                                <em>(<?=$reviews=$db1->getSingleResult("select * from feedback where pages='destination' and prod_id =".$row['id']);?> Review)</em>                                                            </div>                                                            <!--<div class="tg-pricearea">                                                                <del>$2,800</del>                                                                <h4>$2,500</h4>                                                            </div>-->                                                        </div>                                                    </div>                                                </div>                                            </div>		<?php }} ?>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <div class="row"><?php
										$wherestr1=' where populor=1 order by id limit 0,3';	
										$sql="SELECT * from ".$_TBL_DESTINATION.$wherestr1;	
										$db->query($sql);	if($db->numRows()>0)	{	while($row=$db->fetchArray()){	
										$date=explode('-',$row['date']);
										$st=mktime(0,0,0,$date[1],$date[2],$date[0]);
										?>                                            <div class="col-md-4">                                                <div class="item tg-populartour">                                                    <figure>                                                        <a href="tour-destination-details.php?tourid=<?=$row['id']?>">														<?php if(!empty($row['picture'])){ ?>														<img src="destination/<?=$row['picture']?>" alt="image destinations">														<?php }else{ ?>														<img src="img/tours/img-01.jpg" alt="image destinations">														<?php } ?>														</a>                                                        <span class="tg-descount">New</span>                                                    </figure>                                                    <div class="tg-populartourcontent">                                                        <div class="tg-populartourtitle">                                                            <h3><a href="tour-destination-details.php?tourid=<?=$row['id']?>">															<?=$row['title']?></a></h3>                                                        </div>                                                        <div class="tg-description">                                                            <p><?=$row['weither']?></p>                                                        </div>                                                        <div class="tg-populartourfoot">                                                            <div class="tg-durationrating">                                                                <span class="tg-stars"><span></span></span>                                                                <em>(<?=$reviews=$db1->getSingleResult("select * from feedback where pages='destination' and prod_id =".$row['id']);?> Review)</em>                                                            </div>                                                            <!--<div class="tg-pricearea">                                                                <del>$2,800</del>                                                                <h4>$2,500</h4>                                                            </div>-->                                                        </div>                                                    </div>                                                </div>                                            </div>		<?php }} ?>
                    ...
                    <div class="tg-ourdestination">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 tg-verticalmiddle">
                                <figure><img src="img/placeholder-01.png" alt="image destinations"></figure>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 tg-verticalmiddle">
			...
			*************************************-->
            <section class="tg-parallax acllaction">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="tg-calltoaction">
                                    ...
                                    <h2>Get Best Idea's on your Next Travel</h2>
