                    ...
                    <div id="secondary" class="col-md-4 col-lg-3">
                        <div class="search-filter">
                            <div class="search-event-title">
                                <h2><span>Event</span> <?php echo $cat=$_REQUEST['categoty'];?> </h2>
                            </div>
	...
	<?php if($db2->numRows()>0)
		...
		?>
                        <div class="search-result-item">
                            <div class="row">
								<div class="search-result-item-info eventimage col-sm-3">
                                  <a href="event-details.php?eid=<?=$row2['eid']?>">
                                    <img src="images/events/<?=$row['eimageid']?>" alt="<?=$row2['etitle']?>">
                                </a>
                                </div> 
                                <div class="search-result-item-info col-sm-6">
                                    <h3><?=$row2['etitle']?></h3>
                                    <ul class="row">
...
echo $day = date('l', $timestamp);?></span>
                                ...
                                <div class="search-result-item-price col-sm-3">
                                    ...
                                    <strong> ₦ <?=number_format($row2['price'],2);?></strong>
									 <a href="event-details.php?eid=<?=$row2['eid']?>" >Request Now</a><!--class="get-ticket"
