                                ...
                                <div class="user_profile">
                                    <div class="user-pro-img">
                                        <?php if($profilerow['imgid']=='' and empty($profilerow['imgid'])){ ?>
                                            <img src="images/resources/user.png" id="rmvid" alt="" style="width: 150px;">
                                            <?php }else{?>
                                             <img src="upload/<?=$profilerow['imgid']?>" id="rmvid" alt="">
                                           <?php }?>
		   ...
		   <?php }?>
                            ...
                            <div class="product-feed-tab" id="info-dd">
                                <div class="user-profile-ov">
                                    ...
                                    <p><?php echo $profilerow['page_details'];?></p>
                                </div>
                                <!--user-profile-ov end
                                ...
                                <div class="user-profile-ov newcontactabout">
                                    ...
                                    <ul class="list-tab-contact">
                                        <li><span class="lable"> <h3>Establish Since </h3></span> <span class="details"><?=$profilerow['establish']?></span> <span class="eidt-list"><a href="#" title="" class="contact-box-open"><i class="fa fa-pencil"></i></a></span></li>

                                        <li><span class="lable"> <h3>Email </h3></span> <span class="details"><?=$profilerow['email_id']?></span> <span class="eidt-list"><a href="#" title="" class="contact-box-open"><i class="fa fa-pencil"></i></a></span></li>

                                        <li><span class="lable"> <h3>Location </h3></span> <span class="details"><?=$profilerow['location']?></span> <span class="eidt-list"><a href="#" title="" class="contact-box-open"><i class="fa fa-pencil"></i></a></span></li>
                                        ...
                                        <li><span class="lable"> <h3>Total Employees </h3></span> <span class="details"><?=$profilerow['totalemp']?></span> <span class="eidt-list"><a href="#" title="" class="contact-box-open"><i class="fa fa-pencil"></i></a></span></li>
                            ...
                            <div class="product-feed-tab" id="portfolio-dd">
                                <div class="portfolio-gallery-sec">
                                    ...
                                    <div class="gallery_pf">
										...
										<?php
										$dbg=new DB();
										$sqlg="SELECT * from company_document where user_id=".$_SESSION['sess_webid'];
										$dbg->query($sqlg);
										if($dbg->numRows()>0)
										{
