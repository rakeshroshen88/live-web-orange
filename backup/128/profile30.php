                                ...
                                <div class="user_profile">
                                    <div class="user-pro-img">
                                        <?php if($userspath=='' and empty($userspath)){ ?>
                                            ...
                                            <?php }else{?>
                                                <img src="upload/<?=$userspath?>" id="rmvid" alt="">
                                                <?php }?>
									  ...
									  <?php 
                                        ...
                                        <div class="suggestion-usd">
                                          ...
                                          <img src="upload/<?=$userfpath?>" alt="" height="50" width="50">
                                            ...
                                            <span><i class="la la-plus follownew" id="<?=$frow['f_id']?><?=$frow['user_id']?>" fid="<?=$frow['user_id']?>"></i></span>
                                        </div>
										<?php }} ?>
                                ...
                                <div class="product-feed-tab" id="saved-jobs">
                                    ...
                                    <div class="tab-content" id="myTabContent">
										...
										?>
                                                    ...
                                                    <a class="clrbtn follownew" id="<?=$frow['f_id']?>" fid="<?=$frow['user_id']?>" href="javascript:void(0);" > Unfollow</a>
										...
										$dbuf=new DB();
										//$sql="SELECT * from followers where user_id=".$_SESSION['sess_webid'];
										 $sql="SELECT * from followers where user_id IN(SELECT user_id from user_profile where work='".$profilerow['work']."')";
										$db->query($sql);
										if($db->numRows()>0)
										{
										 while($frow=$db->fetchArray()){
...
<?php }else{  echo "Result Not Found";}?>
										...
										$dbuf=new DB();
										//$sql="SELECT * from followers where user_id=".$_SESSION['sess_webid'];
										$sql="SELECT * from followers where user_id IN(SELECT user_id from user_profile where college='".$profilerow['college']."')";
										$db->query($sql);
										if($db->numRows()>0)
										{
										 while($frow=$db->fetchArray()){
										...
										$woorking=$dbuf->getSingleResult('select current_company from user_profile where user_id='.$frow['user_id']);
										$college=$dbuf->getSingleResult('select college from user_profile where user_id='.$frow['user_id']);
										$userfpath=$dbuf->getSingleResult('select image_id from user_profile where user_id='.$frow['user_id']);
										$currentcity=$dbuf->getSingleResult("select current_city from user_profile where user_id=".$frow['user_id']);
										...
										$dbuf=new DB();
										//$sql="SELECT * from followers where user_id=".$_SESSION['sess_webid'];
										 $sql="SELECT * from followers where user_id IN(SELECT user_id from user_profile where current_city='".$profilerow['current_city']."')";
										$db->query($sql);
										if($db->numRows()>0)
										{
										 while($frow=$db->fetchArray()){
                                                                ...
                                                                <li class="feeling-input">
                                                                    ...
                                                                    <div class="comment_box feeling-input">
                                                                        <form id="commentForm" method="post">
                                                                            ...
                                                                            <input type="hidden" name="uid" id="uid" value="<?=$_SESSION['sess_webid']?>">
                                                                            ...
                                                                            <p class="lead emoji-picker-container">
                                                                                <input type="text" placeholder="Post a comment" name="postcomment" data-emojiable="true">
                                                                            </p>
                                                        ...
                                                        <div class="post-bar">
                                                            <div class="post_topbar applied-post">
                                                                ...
                                                                <div class="job_descp noborder">
                                                                    ...
                                                                    <div class="devepbtn appliedinfo noreply">
                                                                        <a class="clrbtn follow" id="f<?=$frow['f_id']?>" fid="<?=$frow['follow']?>" href="javascript:void(0);"> Followers</a>
                                                        ...
                                                        <div class="post-bar">
                                                            <div class="post_topbar applied-post">
                                                                ...
                                                                <div class="job_descp noborder">
                                                                    ...
                                                                    <div class="devepbtn appliedinfo noreply">
                                                                        <a class="clrbtn follownew" id="f<?=$frow['f_id']?>"  fid="<?=$frow['follow']?>" href="javascript:void(0);"> Followers</a>
