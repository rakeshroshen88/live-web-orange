 ...
 <div class="form-group">
	...
	<input name="material" type="text" class="form-control" value="<?=$row['material']?>"/> 
									 ...
									 <div class="form-group">
                                        ...
                                        <label class="col-md-3 control-label" for="size"> Brand</label>
	 ...
	 <!--<dl class="param param-inline">
                                ...
                                <dd>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="size" id="inlineRadio2<?=$row['id']?>" value="SM" <?php if($row['prodsize1']=='SM'){ echo "selected"; }?>>
                                        <span class="form-check-label">SM</span>
                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="size" id="inlineRadio2<?=$row['id']?>" value="MD" <?php if($row['prodsize1']=='MD'){ echo "selected"; }?>>
                                        <span class="form-check-label">MD</span>
                                    </label>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="size" id="inlineRadio2<?=$row['id']?>" value="XXL" <?php if($row['prodsize1']=='XXL'){ echo "selected"; }?>>
