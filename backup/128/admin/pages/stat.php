...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Add/Edit Sustainability</li> <span style="color:red; font-size:14px;"<?=$errMsg?></span>
			</ol>
		</div><!--/.row-->
							...
							<fieldset>
								<!-- Name input-->
                                    	...
                                    	<div class="form-group">
        									<label class="col-md-3 control-label">Sustainability Detail</label>
            									<div class="col-md-9">
