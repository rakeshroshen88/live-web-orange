									...
									<div class="dff-tab current" id="tab-3">
										...
										<div class="map_canvas"></div>
											<div class="row">
												...
												<div class="col-lg-12 no-pdd">
													<div class="sn-field">
													<input type="text" id="countrycode" name="countrycode" placeholder="Country Code " style="width: 38%;
">
...
-->
											...
											<select name="gender" id="gender">
												...
												<div class="col-lg-12 no-pdd">
													<div class="sn-field">
									<?php echo createComboBox($makearr,"country", ""," id='country' class='custom-select d-block w-100'")?>
