...
function createpost(){
	...
	//echo $post_date=date('Y-m-d H:i:s'); 
    ...
    try {
		if($systemToken == $token){
            ...
            $db = getDB();
				 ...
				 $sql="INSERT INTO user_post(user_id, post_title, post_details, post_status, post_date, allpath, postemos, post_hide, pageid, tagfriends, shareuid)VALUES(:user_id, :post_title, :post_details, :post_status, :post_date, :allpath, :postemos, :post_hide, :pageid, :tagfriends, :shareuid)";
                $stmt = $db->prepare($sql);
                $stmt->bindParam("user_id", $user_id,PDO::PARAM_INT);
                ...
                $stmt->bindParam("post_date", $post_date,PDO::PARAM_INT);
