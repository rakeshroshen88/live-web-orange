...
?>
    ...
    <div class="app-heading-container app-heading-bordered bottom">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#">Products Attribute</a></li>
                            ...
                            <div class="app-heading app-heading-small">
                                ...
                                <div class="heading-elements">
                                    ...
                                    <div class="btn-group">
									  ...
									  <a class="btn btn-primary btn-icon-fixed dropdown-toggle" href="//iflex.ng/admin/admin_new/viewcolor.php?act=add&aid=<?=$_SESSION['SES_ADMIN_ID']?>">Export</a>
                                ...
                                <table class="table table-striped table-bordered datatable-extended" id="sortable-data">
									...
									<?php 
                                       ...
                                       <tr role="row" class="odd">
                                           ...
                                           <td><a href="//iflex.ng/admin/admin_new/add_attribute.php?act=edit&id=<?=$row['id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladminnew("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span>
						</a></td>
                                        </tr>
												<?php }else{ ?>
...
function deladminnew(id)
{
	...
	{
		location.href="//iflex.ng/admin/admin_new/viewcolor.php?act=del&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id="+id;
	}
}
