...
function deladminnew(id)
{
	...
	{
		location.href="//iflex.ng/admin/admin_new/extra_list.php?act=del&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id="+id;
	}
}
</script>
...
?>	
                                        ...
                                        <tr>
											...
											<?php if($_SESSION['Super_admin']=='superadmin'){ ?>
											<td><a href="//iflex.ng/admin/admin_new/extra_list.php?act=edit&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id=<?=$row['id']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladminnew("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span>
											</a></td>
											<?php } ?>
                                        </tr>
