...
function deladminnew(id)
{
	...
	{
		location.href="//iflex.ng/admin/admin_new/deliverycharge.php?act=del&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id="+id;
	}
}
</script>
...
?>	
                                        ...
                                        <tr>
											...
											<td><a href="//iflex.ng/admin/admin_new/deliverycharge.php?act=edit&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id=<?=$row['id']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladminnew("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span>
											</a></td>
