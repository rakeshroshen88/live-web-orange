...
function deladminnew(id)
{
	...
	{
		location.href="//iflex.ng/admin/admin_new/restaurants_list.php?act=del&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id="+id;
	}
}
</script>
...
?>	
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="//iflex.ng/admin/admin_new/add_restaurants.php?act=edit&id=<?=$row['id']?>"><?php echo $row['title'];?> </a></td>
                                            ...
                                            <td>  <a href='<?=$_PAGE."?".$qryStr?>&act=dac&id=<?=$row[id]?>&stat=<?=$row['Status']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>'><?=$row['Status']==0?'Deactive':'Active'?></a> </td>

                                           
											<td><a href="//iflex.ng/admin/admin_new/add_restaurants.php?act=edit&id=<?=$row['id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladminnew("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span>
											</a></td>
