...
if($act=='dac')
	{
		if($stat==0)
			...
			$stat=0;
		 $sql="UPDATE ourintrest SET status= '$stat' WHERE id='$id'";
		$db->query($sql);
...
if($act=='del')
	{
		...
		$sql="DELETE FROM ourintrest WHERE id='$id'";
		$db->query($sql);
...
$updatearr=array(	 "title"=>$_REQUEST['catname'],
	...
	if(matchExists('ourintrest', $whereClause))
		{
			...
			if($act=="edit")
				{
					...
					updateData($updatearr, 'ourintrest', $whereClause);
					$where=" id=".$catid;
    ...
    <div class="app-heading-container app-heading-bordered bottom">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Manage interest category</li>
...
function deladmin(id)
{
    ...
    <div class="page_container">
        ...
        <div class="container">
                      ...
                      <div class="block block-condensed">
                            ...
                            <div class="app-heading app-heading-small">
                                ...
                                <div class="title">
                                    ...
                                    <h5>Manage interest category</h5>
                            ...
                            <a href="?act=add&aid=<?=$_SESSION['SES_ADMIN_ID']?>" class="btn btn-primary btn-icon-fixed">Add interest category</a>
			...
			$db1=new DB();
			$ct=1;
			$sql="SELECT * from ourintrest order by id desc";
			$db->query($sql);		
...
<?php if(!empty($errMsg1)){?>
				  ...
				  <?php 
							 ...
							 $sql2="SELECT * FROM ourintrest where id=".$_REQUEST['id'];
...
.btn-primary {
    ...
    <div class="panel-heading bg-completed">
        <p class="lead m-n">Add interest</p>
    </div><!-- /.panel-heading -->
    ...
    <div class="panel-body">
            ...
            <div class="input-group">
               <textarea name="cat_desc" class="form-control"><?=$row['idesc']?></textarea>
