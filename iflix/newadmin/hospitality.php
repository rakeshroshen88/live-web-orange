...
if($act=='del')
	{
		...
		$sql="DELETE FROM hospitality WHERE id='$id'";
		$db->query($sql);
...
$updatearr=array(	 "title"=>$_REQUEST['catname'],
    ...
    <div class="app-heading-container app-heading-bordered bottom">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Manage Hospitality</li>
...
function deladmin(id)
{
    ...
    <div class="page_container">
        ...
        <div class="container">
            ...
            <div class="row">
                  ...
                  <div class="col-md-9">
                      ...
                      <div class="block block-condensed">
                            ...
                            <a href="?act=add&aid=<?=$_SESSION['SES_ADMIN_ID']?>" class="btn btn-primary btn-icon-fixed">Add Hospitality</a>
			...
			$db1=new DB();
			$ct=1;
			$sql="SELECT * from hospitality order by id desc";
			$db->query($sql);		
...
<?php if(!empty($errMsg1)){?>
				  ...
				  <?php 
							...
							$sql2="SELECT * FROM hospitality where id=".$_REQUEST['id'];
...
.btn-primary {
    ...
    <div class="panel-heading bg-completed">
        <p class="lead m-n">Add/HOSPITALITY</p>
    </div><!-- /.panel-heading -->
    ...
    <div class="panel-body">
            ...
            <div class="input-group">
               <textarea name="cat_desc" class="form-control editor-base"><?=$row['h_desc']?></textarea>
