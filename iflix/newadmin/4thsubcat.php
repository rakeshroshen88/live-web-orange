...
function deladmin(id)
{
	...
	{
		location.href="https://iflex.ng/admin/admin_new/4thsubcat.php?act=del&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id="+id;
	}
}
</script>
...
$st=mktime(0,0,0,$date[1],$date[2],$date[0]);			
	...
	<tr>
						<td><?=$ct?></td>
                        <td> <a href="https://iflex.ng/admin/admin_new/add_4thsubcat.php?act=edit&id=<?=$row['id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"><?=$row['thirdsubcatname']?></a></td>
 ...
 <td ><?=$subcatname?></td>
                    ...
                    <td> <a href='https://iflex.ng/admin/admin_new/4thsubcat.php?act=dac&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id=<?=$row['id']?>&stat=<?=$row['thirdstatus']?>'><?=$row['thirdstatus']=='0'?'Deactive':'Active'?></a> </td>
                           
                        <td > <a href="https://iflex.ng/admin/admin_new/add_4thsubcat.php?act=edit&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id=<?=$row['id']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span></a>
						</td>
                     </tr>
