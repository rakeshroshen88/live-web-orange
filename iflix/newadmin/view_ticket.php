                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="app-widget-tile">                                                                                    
                                    ...
                                    <div class="line">
                                        <div class="title wide text-center"><a href="https://iflex.ng/admin/admin_new/view_ticket.php?ts=Open&aid=<?=$_SESSION['SES_ADMIN_ID']?>">Open</a></div>                                                
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="app-widget-tile">                                                                                    
                                    ...
                                    <div class="line">
                                        <div class="title wide text-center"><a href="https://iflex.ng/admin/admin_new/view_ticket.php?ts=In Progress&aid=<?=$_SESSION['SES_ADMIN_ID']?>">In Progress</a></div>                                                
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="app-widget-tile">                                                                                    
                                    ...
                                    <div class="line">
										...
										<a href="https://iflex.ng/admin/admin_new/view_ticket.php?ts=Closed&aid=<?=$_SESSION['SES_ADMIN_ID']?>">Closed</a></div>                                                
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
...
<tr>
						<td><?=$ct?></td>
                        <td> <a href="//iflex.ng/admin/admin_new/ticket_reply.php?act=edit&id=<?=$row['id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"><?=$row['subject']?></a>(<?=$unread?>)</td>
                        ...
                        <td > <a href="//iflex.ng/admin/admin_new/ticket_reply.php?act=edit&id=<?=$row['id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span>						</a>
						</td>
                     </tr>
