...
function deladmin(id)
{
	...
	{
		location.href="https://iflex.ng/admin/admin_new/category_list.php?act=del&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id="+id;
	}
}
</script>
...
$st=mktime(0,0,0,$date[1],$date[2],$date[0]);		
	...
	<tr>
						<td><?=$ct?></td>
                        <td> <a href="https://iflex.ng/admin/admin_new/add_category.php?act=edit&id=<?=$row['id']?>"><?=$row['catname']?></a></td>
                    ...
                    <td> <a href='https://iflex.ng/admin/admin_new/category_list.php?act=dac&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id=<?=$row['id']?>&stat=<?=$row['status']?>'><?=$row['status']=='no'?'Deactive':'Active'?></a> </td>
                        ...
                        <td > <a href="https://iflex.ng/admin/admin_new/add_category.php?act=edit&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id=<?=$row['id']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span></a>
						</td>
                     </tr>
