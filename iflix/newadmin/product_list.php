...
function deladminnew(id)
{
	...
	{
		location.href="//orangestate.ng/admin/admin_new/product_list.php?act=del&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id="+id;
	}
}
</script>
...
?>	
                                        ...
                                        <tr>
										   ...
										   <?php } ?>
                                            ...
                                            <td>  <a href='<?=$_PAGE."?".$qryStr?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>&act=dac&id=<?=$row[id]?>&stat=<?=$row[prod_status]?>'><?=$row[prod_status]==0?'Deactive':'Active'?></a> </td>

                                            <!--<td><a href=""> Edit </a> <a href=""> Delete </a></td>-->
											<td><a href="//iflex.ng/admin/admin_new/add_product.php?act=edit&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id=<?=$row['id']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladminnew("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span>
											</a></td>
