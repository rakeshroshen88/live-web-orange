...
function deladmin(id)
{
	...
	{
		location.href="https://iflex.ng/admin/admin_new/view_adds.php?act=del&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id="+id;
	}
}
</script>
...
<tr>
						<td><?=$ct?></td>
                        <td> <a href="//iflex.ng/admin/admin_new/add_edit_adds.php?act=edit&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id=<?=$row['id']?>"><?=$row['img_type']?></a></td>
							
                       <td> <?=$row['addlink']?></td>
						<td> <?php echo date('d M,Y',$st);?></td>
                    <td> <a href='//iflex.ng/admin/admin_new/view_adds.php?act=dac&id=<?=$row['id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>&stat=<?=$row['homestatus']?>'><?=$row['homestatus']==0?'Deactive':'Active'?></a> </td>
                           
                        <td > <a href="//iflex.ng/admin/admin_new/add_edit_adds.php?act=edit&id=<?=$row['id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span>						</a>
						</td>
                     </tr>
