...
if(empty($sta)){ $sta="Unpaid"; }
									?>							<tr>						<td><?=$ct?></td>                         <td><a href="//iflex.ng/admin/admin_new/hotel_order_view.php?id=<?=$row[orderid]?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"><?=$row['orderid']?></a></td>						 <td ><?=date('dS'.' '.'M',$stamp1)?><?=date('Y',$stamp1)?></td>						 
									
									<td ><?php echo $name;?></td>	
									
									<td align='center'> <?=$row['hotel_name']?></td>                           						<td align='center'>₦ <?=$row['totalamount']?></td>																													                           <td>					   <?php echo $sta;?>							  </td>                        							 <td><a href="//iflex.ng/admin/admin_new/hotel_order_view.php?id=<?=$row['orderid']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span>						</a>							</td>                     </tr>
