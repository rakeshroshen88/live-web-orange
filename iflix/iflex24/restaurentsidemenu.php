<div class="app-sidebar app-navigation app-navigation-fixed scroll app-navigation-style-default app-navigation-open-hover dir-left mCustomScrollbar _mCS_1 mCS-autoHide app-navigation-fixed-absolute app-navigation-minimized mCS_disabled" data-type="close-other">
						 ...
						 <li>
							<?php 
                                ...
                                <ul> 		
								 ...
								 <li><a href="https://iflex.ng/admin/admin_new/view_user.php?aid=<?=$_SESSION['SES_ADMIN_ID']?>"><span class="nav-icon-hexa">View</span> Client</a></li>
	...
	<li>
	 <a href="#"><span class="nav-icon-hexa text-orange-100">OM</span> Order Management <span class="label label-success label-bordered label-ghost">+<?=$totaluser?></span></a> <ul>
						<li>
								 <a href="https://iflex.ng/admin/admin_new/restautant_order.php?aid=<?=$_SESSION['SES_ADMIN_ID']?>"><span class="nav-icon-hexa">View</span> Food Order</a>
							...
							<?php 
								...
								<li><a href="https://iflex.ng/admin/admin_new/recipe_list.php?act=add?aid=<?=$_SESSION['SES_ADMIN_ID']?>"><span class="nav-icon-hexa">View</span> Product</a>
								<ul><li><a href="https://iflex.ng/admin/admin_new/recipe_list.php?aid=<?=$_SESSION['SES_ADMIN_ID']?>"><span class="nav-icon-hexa">View</span> Product</a></li>
