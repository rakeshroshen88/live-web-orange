...
<tr>
						<td><?=$ct?></td>
                        <td> <a href="//iflex.ng/admin/admin_new/add-hotel.php?act=edit&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id=<?=$row['id']?>"><?=$row['title']?></a></td>
							
                       
						<td> <?php echo date('d M,Y',$st);?></td>
                    <td> <a href='//iflex.ng/admin/admin_new/hotel_list.php?act=dac&id=<?=$row['id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>&stat=<?=$row['status']?>'><?=$row['status']==0?'Deactive':'Active'?></a> </td>
                           
                        <td > <a href="//iflex.ng/admin/admin_new/add-hotel.php?act=edit&id=<?=$row['id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span>						</a>
						</td>
                     </tr>
