                                ...
                                <ul class="app-feature-gallery app-feature-gallery-noshadow margin-bottom-0">
                                    <li>
                                        ...
                                        <div class="app-widget-tile">
                                            ...
                                            </div>  <?php																					$totalorder=$db->getSingleResult("SELECT count(id) from food_order where  resturant_id=".$_SESSION['rid']);											?>                                      
                                    ...
                                    <li>
                                        ...
                                        <div class="app-widget-tile">
                                            ...
                                            </div>                                        <?php	$nooforder=$db->getSingleResult("SELECT count(id) from food_order where order_status='0'  and  resturant_id=".$_SESSION['rid']);																 ?>
                                    ...
                                    <li>
                                        ...
                                        <div class="app-widget-tile">
                                            ...
                                            </div>  <?php										$totalcorder=$db->getSingleResult("SELECT count(id) from food_order where order_status='2' and  resturant_id=".$_SESSION['rid']);																																												if(empty($totalcorder)){ $totalcorder=0;}											?>                                            
                                    ...
                                    <li>
                                        ...
                                        <div class="app-widget-tile">
                                            <div class="line">
                                                <div class="title">Cancel Order</div><?php										$totalcanorder=$db->getSingleResult("SELECT count(id) from food_order where order_status='1' and  resturant_id=".$_SESSION['rid']);
												if(empty($totalcanorder)){ $totalcanorder=0;}											?>
                                        ...
                                        <div class="app-widget-tile app-widget-highlight">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">                                                    
                                                    ...
                                                    </div>                                        <?php $totalsum=$db->getSingleResult("SELECT sum(totalprice) from food_order where  resturant_id=".$_SESSION['rid']);?>
                                                    <div class="intval text-left"><?=$totalsum?></div>                                        
                                                    <div class="line">
                                                        <div class="subtitle">Latest back up: <a href="#"><?=date('d /m/ Y')?></a></div>
                                                    </div>
                                                </div>
                                            </div>                                            
                                        </div>
                                    ...
                                    <li>                                        
                                        ...
                                        <div class="app-widget-tile app-widget-highlight">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">                                                    
                                                    <div class="line">
                                                        <div class="title">Last Transaction Amount</div>
                                                        <div class="subtitle pull-right text-success"><span class="fa fa-check"></span> UP</div>
                                                    </div>   <?php $lasttnsamount=$db->getSingleResult("SELECT sum(totalprice) from food_order where  resturant_id=".$_SESSION['rid']." order by id desc limit 0,1");?>                                      
                                                    <div class="intval text-left"><?=$lasttnsamount?></div>
                                                    <div class="line">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="contact contact-rounded contact-bordered contact-lg">
                                                              <?php if(empty($image_id)){?>					<img src="https://iflex.ng/images/resources/user.png" height="40" alt=""  /> 					<?php }else{?>					<img src="https://iflex.ng/upload/<?=$image_id?>" alt="" height="40" /> 					<?php }?> 
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-left">
                                                                    <li><a href="//iflex.ng/admin/admin_new/food_order_details.php?id=<?=$row['orderid']?>"><span class="icon-question-circle text-info"></span> More information</a></li> 
