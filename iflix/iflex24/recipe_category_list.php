...
function deladmin(id)
{
	...
	{
		location.href="https://iflex.ng/admin/admin_new/recipe_category_list.php?act=del&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id="+id;
	}
}
</script>
...
$st=mktime(0,0,0,$date[1],$date[2],$date[0]);		
	...
	<tr>
						<td><?=$ct?></td>
                        <td> <a href="https://iflex.ng/admin/admin_new/add_recipe_cat.php?act=edit&id=<?=$row['id']?>"><?=$row['catname']?></a></td>
							
                   <td>0</td>
				   <td>0</td>
						<td> <?php echo date('d M,Y',$st);?></td>
                    <td> <a href='https://iflex.ng/admin/admin_new/recipe_category_list.php?act=dac&id=<?=$row['id']?>&stat=<?=$row['status']?>'><?=$row['status']=='no'?'Deactive':'Active'?></a> </td>
                           
                        <td > <?php if($_SESSION['Super_admin']=='superadmin'){ ?>
						<a href="https://iflex.ng/admin/admin_new/add_recipe_cat.php?act=edit&id=<?=$row['id']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> 
