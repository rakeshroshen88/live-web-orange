		...
		<div class="chat_message_area">
			...
			<div class="image_upload">
				<form id="uploadImage" method="post" action="upload.php">
					<label for="uploadFile"><img src="<?=$_SITE_PATH?>chat/upload.png" /></label>
...
setInterval(function(){
  ...
  */
	...
	{
		$.ajax({
			url:"<?=$_SITE_PATH?>chat/update_last_activity.php",
			success:function()
			{
                            ...
                            <div class="single-footer mb-sm-40">
                                ...
                                <div class="footer-content">
                                    <ul class="footer-list">
                                        ...
                                        <li><a href="https://iflex.ng/submitticket.php">Help</a></li>
										
										<li><a href="https://iflex.ng/submitticket.php">Submit Tickets</a></li>
                            ...
                            <div class="single-footer mb-sm-40">
                                ...
                                <div class="footer-content">
                                    <ul class="footer-list address-content">
                                        ...
                                        <li><i class="lnr lnr-envelope"></i><a href="#"> mail Us: Support@iflex.com </a></li>
                                        <li>
                                            <i class="lnr lnr-phone-handset"></i> Phone: (+800) 123 456 789)
                                        </li>
                                    </ul>
                                    <div class="payment mt-25 bdr-top pt-30">
                                        <a href="#"><img class="img" src="<?=$_SITE_PATH?>img/1.png" alt="payment-image"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="footer-bottom pb-30">
                <div class="container">
                     ...
                     <div class="copyright-text text-center">
                        <p>Copyright © 2019 <a target="_blank" href="orangestate.ng">iflex</a> All Rights Reserved.</p>
                     </div>
                </div>
                <!-- Container End -->
            </div>
