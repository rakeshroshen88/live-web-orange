  ...
  $sql1="SELECT * FROM cities WHERE state_id='$stateid'";
		...
		<?php } ?>                          
									...
									<div class="form-group col-md-6">
                                        <label class="col-md-12 control-label" for="name"> Hotel Name <span class="required">*</span></label>
                                        <div class="col-md-12">
...
<div class="row" >
<div class="form-group">
                                        <label class="col-md-12 control-label" for="name"> Hotel Amenities</label>
                                        <div class="col-md-12">
										<div class="data">
							      <?php           
     $db1=new DB();
    ...
    <label for="employee"><?php echo $row1['title']?></label>
							...
							<input type='hidden' name="amenities1"  value='<?php echo $row['amenities']?>' />
									...
									<div class="row" >
									<div class="form-group col-md-6">
                                        <label class="col-md-12 control-label" for="name"> No of Rooms <span class="required">*</span></label>
                                        <div class="col-md-12">
									...
									<div class="form-group col-md-6">
                                        <label class="col-md-12 control-label" for="name"> No of Floors</label>
                                        <div class="col-md-12">
						...
						<option value='5' <?php if($row['starrating'] == 5){ echo 'selected'; } ?>>5 Star Rating</option>
								...
								<div class="row" >
								<div class="form-group col-md-6">
                                        <label class="col-md-12 control-label" for="name"> Check In</label>
                                        <div class="col-md-12">
									 ...
									 <div class="form-group col-md-6">
                                        <label class="col-md-12 control-label" for="name"> Check Out</label>
                                        <div class="col-md-12">
									...
									<div class="row" >
							   <div class="form-group col-md-6">
                                        <label class="col-md-12 control-label" for="sortdetail"> Sort Details</label>
                                        <div class="col-md-12">
...
{
	var aurl='<?=$_SITE_PATH?>admin/pages/delete-filehotels.php";
