...
<div class="row">
                                        ...
                                        <label class="col-md-12 control-label" for="name"> Room Type<span class="required">*</span></label>
                                        <div class="col-md-12">
							<?php 
                  ...
                  <?php }?>
													...
													<div class="form-group col-md-6">
                                        <label class="col-md-12 control-label" for="name"> Hotel<span class="required">*</span></label>
                                        <div class="col-md-12">
							<?php 
...
<div class="row" >
									<div class="form-group col-md-6">
                                        ...
                                        <input name="price" type="number" class="form-control" value="<?=$row['price']?>"/>  
                                                    ...
                                                    <div class="row" >
									<div class="form-group col-md-6">
                                        <label class="col-md-12 control-label" for="name"> Room Amenities</label>
                                        <div class="col-md-12">
                                        <div class="data">
	  <?php           
      $db1=new DB();
	  ...
	  <?php  }}
						if(empty($facilityid)){ $facilityid=0;}	
	  ...
	  ?>	
		<div class="app-checkbox success inline"> 
							...
							<input type='hidden' name="flightid1"  value='<?php echo $row['facilityid']?>' />
									...
									<div class="form-group col-md-6">
                                        <label class="col-md-12 control-label" for="name"> Room Detail :</label>
                                        <div class="col-md-12">
...
<div class="form-group col-md-6">
        									...
        									<div class="col-md-12">
                                                <input type="file" name="largeimage" id="largeimage"><span style="color:#FF0000;">(jpg, gif, png)</span>  <?php if($row['picture']){?><a href="javascript:void(0)" onclick="javascript:window.open('../viewaimage.php?room=<?=$row['picture']?>','imgid','height=510,width=660,toolbars=no,left=150,top=200');">View Image</a><?php }?>
...
var str=$(this).val();
	var social_AjaxURL='<?=$_SITE_PATH?>admin/pages/ajhotel.php';
...
{
	var aurl='<?=$_SITE_PATH?>admin/pages/delete-filerooms.php";
