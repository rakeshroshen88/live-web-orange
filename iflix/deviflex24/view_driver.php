...
function deladmin(id)
{
	...
	{
		location.href="https://iflex.ng/admin/admin_new/view_user.php?act=del&aid=<?=$_SESSION['SES_ADMIN_ID']?>&id="+id;
	}
}
</script>
...
?>             <tr>
						<td><?=$ct?></td>
                        <td> <a href="//iflex.ng/admin/admin_new/user_profile.php?act=edit&id=<?=$row['user_id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"><?=$row['first_name']?></a></td>
							
                        <td> <?=$row['email_id']?></td>
						<td> <?php echo date('d M,Y',$st);?></td>
                    <td> <a href='//iflex.ng/admin/admin_new/view_user.php?act=dac&id=<?=$row['user_id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>&stat=<?=$row['user_status']?>'><?=$row['user_status']==0?'Deactive':'Active'?></a> </td>
                           
                        <td > <a href="//iflex.ng/admin/admin_new/add_users.php?act=edit&id=<?=$row['user_id']?>&aid=<?=$_SESSION['SES_ADMIN_ID']?>"> <span class="glyphicon glyphicon-edit" title="Edit"></span> &nbsp;<a href='javascript:deladmin("<?=$row['user_id']?>")'> <span class="glyphicon glyphicon-trash" title="Delete"></span>						</a>
						</td>
                     </tr>
