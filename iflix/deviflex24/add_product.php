    ...
    <div class="page_container">
        ...
        <div class="col-xs-2">
            ...
            <ul class="nav nav-tabs tabs-left">
                ...
                <li><a href="#Policies" data-toggle="tab">Return Policy
				 <span><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></span></a></li>      
 ...
 <textarea name="sort_detail" class="editor-base" ><?=$row['sort_detail']?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <label class="col-md-2 control-label">Enter Manufacturer  </label>
                                    ...
                                    <div class="block-content margin-bottom-0">
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <label class="col-md-2 control-label">Retail Price <span class="required">*</span></label>

                                                        <div class="col-md-10">

                                                                N<input name="prodprice" id="prodprice" type="text" class="form-control" value="<?=$row['prod_price']?>" / > 
...
<div class="form-group">
								...
								<?php //echo $array_values; ?>
								 <label class="col-md-2 control-label" for="size"> Add Attributes  (If applicabe)</label>
				<div class="col-md-10">
				<p><button class=" btn btn-info pull-right hidden-mobile">Add Attributes</button></p>
				<div class="wrapper" style="display:none;">
				<?php 
				$color=$row['color'];
				//$quantity=$row['quantity']add_fields;
				...
				<div class="col-md-2">
					<label class="" for="Quantity"> Quantity<span class="">*</span></label><input type="text" name="input_array_qtn[]" class="form-control" id="quantity"  placeholder="Quantity" value="<?=$rownew['prodquantity']?>"  /></div>
					
					<div class="col-md-2">
					<label class="" for="Price"> Price<span class="">*</span></label>
					<input type="text" name="input_array_type[]" class="form-control" placeholder="Price" value="<?=$rownew['prodprice']?>" /></div>
				<div class="col-md-2">
				<label class="" for="Capacity"> Capacity<span class="">*</span></label>
				...
				?><div class="row" style="display: flex;">
					...
					<div class="col-md-2">
					<label class="" for="Quantity"> Quantity<span class="">*</span></label>
				...
				<?php } ?>
					<p><button class="add_fields btn btn-info pull-right hidden-mobile">Add Attributes</button></p>
						</div>
					<br/>
                                ...
                                <div class="block block-condensed">
                                     ...
                                     <div class="app-heading app-heading-small">                                
                                        ...
                                        <div class="title">
                                            ...
                                            <p>Return Policy of the Product</p>
...
<p id="demo"></p>-->  
<script type="text/javascript" src="<?=$_SITE_PATH?>js/sweetalert2@8.js"></script>  
<?php							
								$db22=new DB();
							   $sql22="SELECT * FROM allproductcolor";
							$db22->query($sql22)or die($db22->error());
...
$("#category").change(function() {
  var str=$(this).val();
	...
	var social_AjaxURL='<?=$_SITE_PATH?>admin/pages/ajax_subcat.php';
...
jQuery(document).on("change","#subcategory",function(){
 ...
 var cid1 = jQuery(this).attr('cid');	
  ...
  var cid = jQuery('#category').val();
	var social_AjaxURL='<?=$_SITE_PATH?>admin/pages/ajax_2nd.php';
...
var str=$(this).val();
	var social_AjaxURL='<?=$_SITE_PATH?>admin/pages/ajax_4thcat.php';
   ...
   var social_AjaxURL='<?=$_SITE_PATH?>admin/pages/uploadprod.php';
   ...
   $.ajax({
     ...
     processData: false,
     success: function (response) {
		jQuery(".uploaded-img").append( '<tr class="im'+ a +'"><td>'+ a +'</td> <td><div class="thmis"><img src="'<?=$_SITE_PATH?>'product/'+ response +'" width="50"></div></td><td><input type="radio" id="pimage" name="pimage" value="'+ response +'" pimage="'+ response +'" class="pimagenew"></td><td><button class="btn btn-default btn-icon deleteimg1" img="'+ a +'"><span class="fa fa-times"></span></button></td></tr>');
...
jQuery(document).on("click", ".deleteimg", function(e){
		...
		var img = jQuery(this).attr('img');
		var social_AjaxURL='<?=$_SITE_PATH?>admin/pages/imgdelete.php';
