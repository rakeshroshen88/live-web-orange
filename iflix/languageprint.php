...
$db2=new DB();
if($target=='Ibibio' or $target=='Anang' or $target=='Oron' or $target=='Yoruba' or $source=='Ibibio' or $source=='Anang' or $source=='Oron' or $source=='Yoruba' or $source=='Igbo' or $source=='Hausa'){
	$dbuf=new DB();
	if($target=='Ibibio' or $target=='Anang' or $target=='Oron' or $target=='Yoruba' or $target=='Igbo' or $target=='Hausa'){
