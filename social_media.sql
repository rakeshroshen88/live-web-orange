...
INSERT INTO `all_user` (`user_id`, `first_name`, `last_name`, `display_name`, `mobile_no`, `email_id`, `joindate`, `country`, `user_status`, `password`) VALUES
(1, 'chittaranjan', 'Roy', NULL, 1234567890, 'admin@gmail.com', '2019-10-11', 'India', '1', '123456'),
(2, 'roy', 'chittaranjan', NULL, 1236547890, '111admin@gmail.com', '2019-10-12', 'india', '0', 'MTIzNjU0');
